<template>
  <div class="index-aside">
    ...
    <basic-panel class="panel focus-me">
      ...
      <template>
        <p>
          github: <a class="my-github" href="https://github.com/alsritter" target="_blank">https://github.com/alsritter</a>
        </p>
        <p>
          静态页面：<a class="my-github" href="https://alsritter.icu/" target="_blank">https://alsritter.icu/</a>
        </p>
      </template>
    </basic-panel>
  </div>
